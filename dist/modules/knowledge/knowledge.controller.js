...
export async function createItem(req, res, next) {
    try {
        ...
        const item = await knowledgeService.createKnowledgeItem(workspaceId, req.userId, { sourceUrl, userIntent });
...
export async function getItems(req, res, next) {
    try {
        ...
        paginatedResponse(res, result.items, result.pagination.page, result.pagination.limit, result.pagination.total);
    }
    catch (error) {
        next(error);
    }
