...
import { createSpaceSchema, createElementSchema, updateElementSchema, moveElementSchema, } from './whiteboard.types.js';
...
router.put('/:spaceId/elements/:elementId/move', requireRole('OWNER', 'EDITOR'), rateLimit('move-element', 1000), validateRequest(moveElementSchema), whiteboardController.moveElement);
