...
router.post('/:spaceId/elements', requireRole('OWNER', 'EDITOR'), rateLimit('create-element', 500), validateRequest(createElementSchema), whiteboardController.createElement);
