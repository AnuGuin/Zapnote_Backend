...
router.patch('/me', rateLimit('update-profile', 10, 3600), validateRequest(updateProfileSchema), userController.updateProfile);
router.get('/me/stats', userController.getStats);
router.get('/me/workspaces', userController.getWorkspaces);
router.delete('/me', rateLimit('delete-account', 1, 3600), userController.deleteAccount);
